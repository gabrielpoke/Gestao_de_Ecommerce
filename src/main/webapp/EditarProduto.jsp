  ...
  <body>
    <div class="container body-content">
      <div class="formulario">
        <form class="form" id="formularioColaborador" action="EditarProduto" method="post">
          <center>
            <legend>
          ...
          <div>
            ...
            <input
              ...
              value="<c:out value="${produtoDAO.codigo}" />"
              required
              readonly
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              required
            > <c:out value="${produtoDAO.descricao}" /> </textarea>
          </div>

    	<div>
           	<label for="ativos">Ativo:</label>
            <select name="ativos" id="ativos">
				<option value="<c:out value="${produtoDAO.ativo}" />"> <c:out value="${produtoDAO.ativo}" /> </option>
          ...
          <div class="button">
            <a href="ListaProduto"> Cancelar </a>
          </div>
        </form>
      </div>
    </div>
