  ...
  <body>
    <div class="container body-content">
      <div class="formulario">
        <form class="form" id="formularioColaborador" action="CadastroColaborador" method="post">
          <center>
            <legend>
          ...
          <div>
            ...
            <input
              ...
              name="cargo"
              value="<c:out value="${colaboradorInf.cargo}" />"
              required
            />
          </div>
          ...
          <div>
           ...
           <div>
            ...
            <select name="ativos" id="ativos">
				<option value="<c:out value="${colaboradorInf.ativo}" />">...</option>
          ...
          <div class="button">
            <a href="ListaColaborador">Listar colaboradores</a>
          </div>
        </form>
      </div>
    </div>
